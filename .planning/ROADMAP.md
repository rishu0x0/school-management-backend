...
- [x] **Phase 1: Database Foundation** (2/3 plans complete) - Supabase schema, RLS policies, and migrations — everything else builds on this
...
- [x] 01-02-PLAN.md — RLS policies for all 7 tables; two-teacher isolation test
